...
export const scenes: Record<string, Scene> = {
  'ch1_sc1': {
    ...
    hotspots: [
      ...
      },
      {
        id: 'bed_tag_spot',
        shape: 'rect',
        coords: [0.0925, 0.8625, 0.1675, 0.9375],
        description: '床腳掛牌',
        hint: '你不是名字，你是床腳的一張紙。',
      },
      {
      ...
      },
      {
        id: 'yoga_mat_spot',
        shape: 'rect',
        coords: [0.385, 0.525, 0.535, 0.675],
        description: '粉紅瑜珈墊',
        hint: '太乾淨了，乾淨得像被反覆擦拭。',
      },
      {
      ...
      },
      {
        id: 'iv_drip_wheel',
        shape: 'rect',
        coords: [0.2125, 0.9125, 0.2875, 0.9875],
        description: '點滴架輪子',
        hint: '輪縫卡著一撮粉紅纖維。',
      },
      {
        id: 'pillow_label',
        shape: 'rect',
        coords: [0.2325, 0.5625, 0.3075, 0.6375],
    ...
    events: [
      {
        ...
        requirements: [
          { type: 'hasInteracted', hotspotId: 'pulse_clip_spot' },
        ],
        effects: [
          { type: 'addItem', itemId: 'pulse_clip' },
          {
            type: 'showDialog',
            dialog: {
      ...
      },
      {
        id: 'pickup_yoga_mat',
        name: '獲得瑜珈墊',
        description: '你收集了粉紅瑜珈墊，並在其中發現生鏽髮夾。',
        requirements: [
          { type: 'hasInteracted', hotspotId: 'yoga_mat_spot' },
        ],
        effects: [
    ...
    hotspots: [
      {
        id: 'mirror',
        shape: 'rect',
        coords: [0.159375, 0.206875, 0.290625, 0.443125],
        description: '破碎的鏡子',
      ...
      },
      {
        ...
        shape: 'rect',
        coords: [0.2325, 0.84375, 0.2575, 0.89625],
        description: '地上的鏡片碎角',
      ...
      },
      {
        id: 'duty_schedule',
        shape: 'rect',
        coords: [-0.0025, 0.1975, 0.1025, 0.3025],
        description: '值班表',
        hint: '背面似乎有字。',
      },
      {
      ...
      },
      {
        id: 'password_panel',
        shape: 'rect',
        coords: [0.926675, 0.826675, 0.950825, 0.850825],
        description: '密碼盤',
        hint: '從鏡子裡看是反的。',
      },
      {
      ...
      },
      {
        id: 'rubber_glove',
        shape: 'rect',
        coords: [0.3575, 0.6775, 0.4025, 0.7225],
        description: '地上的橡膠手套',
      ...
      },
      {
        ...
        shape: 'rect',
        coords: [0.26, 0.5625, 0.31, 0.6375],
  ...
  'ch1_sc3': {
    ...
    hotspots: [
      ...
      },
      {
        id: 'pillow',
        shape: 'rect',
        coords: [0.705, 0.505, 0.795, 0.595],
        description: '枕頭',
        hint: '枕頭下似乎有東西。',
      },
      {
        id: 'bedside_table',
        shape: 'rect',
        coords: [0.69125, 0.42125, 0.75875, 0.48875],
        description: '床頭櫃',
        hint: '床頭櫃的抽屜似乎可以打開。',
      },
      {
        id: 'wardrobe',
        shape: 'rect',
        coords: [0.2195, 0.37775, 0.3005, 0.47225],
        description: '衣櫃',
        hint: '衣櫃門緊閉。',
      },
      {
        id: 'monitor',
        shape: 'rect',
        coords: [0.842625, 0.3263125, 0.957375, 0.3836875],
        description: '監控螢幕',
        hint: '螢幕突然亮起。',
      },
      {
        id: 'sofa_gap',
        shape: 'rect',
        coords: [0.12125, 0.64125, 0.18875, 0.70875],
        description: '沙發縫隙',
        hint: '沙發的縫隙裡似乎有什麼東西。',
      },
      {
        id: 'window',
        shape: 'rect',
        coords: [0.36875, 0.3825, 0.48125, 0.5175],
        description: '落地窗',
        hint: '需要手把才能打開。',
      },
      {
        id: 'size_tag',
        shape: 'rect',
        coords: [0.185, 0.3575, 0.215, 0.4025],
      ...
      },
      {
        id: 'carpet_fray',
        shape: 'rect',
        coords: [0.585, 0.68125, 0.675, 0.71875],
        description: '地毯毛邊的方向',
        hint: '毛邊被拖出一條弧線。',
      },
    ],
    ...
    hotspotEventMap: {
      ...
      'pillow': 'pickup_diary',
      'bedside_table': 'pickup_consent_form',
      'sofa_gap': 'find_handle',
    },
    events: [
      {
        id: 'pickup_recorder',
  ...
  'ch1_sc4': {
    ...
    hotspotEventMap: {
      ...
      'pain_patch_spot': 'pickup_pain_patch',
    },
    events: [
      {
